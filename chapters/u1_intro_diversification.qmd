...
Extraeremos y ordenaremos los tiempos de especiación del árbol:

```{r}
# Obtener y ordenar los tiempos de especiación
# La función getx() extrae los tiempos para cada nodo del árbol.
...
grid <- 0.2   # Tamaño de la ventana de búsqueda de cambios de tasa (en millones de años)
